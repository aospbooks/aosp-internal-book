...
When the user asks about an AOSP subsystem, identify the matching Part below and read the file at `parts/<part-id>.md` for the full chapter content.
...
### sdv — Part XVI: Software Defined Vehicle
